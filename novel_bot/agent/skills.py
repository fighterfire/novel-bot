...
class SkillsLoader:
    ...
    def list_skills(self, filter_unavailable: bool = True) -> List[Dict[str, str]]:
        ...
        def scan_skills_dir(skills_dir: Path, source: str):
        ...
        scan_skills_dir(self.workspace_skills, "workspace")
        scan_skills_dir(self.builtin_skills, "builtin")
    ...
    def load_skill(self, name: str) -> Optional[str]:
        ...
        """
        def find_in_dir(skills_dir: Path) -> Optional[str]:
            if not skills_dir.exists():
                return None
            for skill_dir in skills_dir.iterdir():
                if skill_dir.is_dir():
        ...
        result = find_in_dir(self.workspace_skills)
        if result:
            return result
        return find_in_dir(self.builtin_skills)
